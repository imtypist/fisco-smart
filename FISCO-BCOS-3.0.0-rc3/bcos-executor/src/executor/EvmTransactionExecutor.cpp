...
#include "../precompiled/extension/InferencePrecompiled.h"
...
void EvmTransactionExecutor::initPrecompiled()
{
    ...
    m_constantPrecompiled->insert({"0000000000000000000000000000000000005001",
        std::make_shared<precompiled::InferencePrecompiled>(m_hashImpl)});
